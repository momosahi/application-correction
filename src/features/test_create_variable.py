...
class TestCreateVariable(unittest.TestCase):
    ...
    def test_create_variable_title_default_variable_name(self):
        ...
        result = create_variable(self.data)
    ...
    def test_create_variable_title_custom_variable_name(self):
        ...
        result = create_variable(self.data, variable_name="Name")
        self.assertTrue(result["Title"].equals(expected_result["Title"]))
    ...
    def test_create_variable_title_replace_dona(self):
        ...
        expected_result = pd.DataFrame({"Title": ["Mrs.", "Mr.", "Mrs."], "Age": [39, 22, 38], "Survived": [1, 0, 1]})
        result = create_variable(data, variable_name="Name")
        self.assertTrue(result["Title"].equals(expected_result["Title"]))
